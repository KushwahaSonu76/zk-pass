...
exports.pureCircuits = exports.calculateMerkleRoot = exports.computeCommitment = void 0;
...
function computeCommitment(secret, salt) {
...
function calculateMerkleRoot(leaf, path, index) {
