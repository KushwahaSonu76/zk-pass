...
export const Navbar: React.FC<NavbarProps> = ({ wallet, onConnectWalletType, onDisconnect }) => {
  return (
    <header className="sticky top-0 z-50 cyber-card border-b border-slate-800/80 backdrop-blur-2xl">
        ...
        <div className="flex items-center space-x-3.5">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <span className="text-2xl font-black tracking-wider font-mono text-white">
                Zk<span className="text-glow-emerald">Pass</span>
              </span>
            ...
            <p className="text-[11px] text-slate-400 font-mono flex items-center gap-1.5 mt-0.5">
              <Cpu className="w-3.5 h-3.5 text-prism-emerald" /> Midnight Blockchain • ZK Credential Vault
            </p>
          </div>
        </div>
